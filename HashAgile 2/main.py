...
def index_data(p_collection_name, p_exclude_column):
    try:
        df = pd.read_csv(r"C:\Users\vinit\Downloads\HashAgile 2\Employee Sample Data 1.csv", encoding='ISO-8859-1')
...
def main():
    v_name_collection = "vinith_kumar_g1"
    v_phone_collection = "hash_9400"
